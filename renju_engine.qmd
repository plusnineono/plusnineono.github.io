...
<style>
  ...
  .renju-app .wrap { display: flex; flex-direction: column; gap: 16px; padding: 4px 0 14px; max-width: 760px; margin: 0 auto; }
  .renju-app .boardBox { width: 100%; margin: 0 auto; }
  ...
  .renju-app .row { display: flex; gap: 10px; flex-wrap: wrap; }
  ...
  .renju-app .infoGrid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-top: 2px; }
  ...
  @media (max-width: 520px) {
    .renju-app .infoGrid { grid-template-columns: 1fr 1fr; }
  }
</style>
...
<div class="wrap">
  <div class="boardBox"><canvas id="board" width="760" height="760"></canvas></div>
