...
<style>
  ...
  .renju-app .wrap { display: grid; grid-template-columns: minmax(0, 1fr) 300px; gap: 16px; padding: 4px 16px 14px; max-width: 1080px; margin: 0 auto; align-items: start; }
  ...
  .renju-app canvas { display: block; width: 100%; max-width: 100%; aspect-ratio: 1 / 1; height: auto; background: var(--board); border-radius: 18px; border: 2px solid #9d7741; cursor: pointer; touch-action: manipulation; margin: 0 auto; }
  ...
  @media (max-width: 820px) {
    .renju-app .wrap { grid-template-columns: 1fr; max-width: 560px; }
  }
</style>
